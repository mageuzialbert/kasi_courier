...
export default function AdminModulesPage() {
  ...
  const adminCards = [
    ...
    {
      title: 'Suppliers',
      description: 'Manage expense suppliers and contacts',
      icon: Building2,
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-gray-900 mb-2">Admin Modules</h1>
      <p className="text-gray-600 mb-8">Access and manage all platform modules</p>
